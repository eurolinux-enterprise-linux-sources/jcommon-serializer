*************************************************
* JCOMMON Serializer: Version 0.3.0             *
*************************************************

30 May 2008

(C)opyright, 2006-2008, by Pentaho Corporation, Object Refinery Limited and Contributors.
...
JCommon-Serializer is licensed, free of charge, under the terms of the GNU Lesser
General Public Licence.  A copy of the licence is included in the download.

For the latest news and information about JCommon-Serializer, please refer to:

    http://reporting.pentaho.org/jcommon-serializer/


2. REQUIREMENTS
---------------
JCommon-Serializer needs at least JDK 1.2.2 for its functionality.
...
4. REPORTING BUGS
-----------------
If you find bugs in JCommon-Serializer, we'd like to hear about it so that we
can improve future releases of JCommon-Serializer.  Please post a bug report
...
know the version of JCommon-Serializer that you are using, the JDK version,
...
Ant script (tested using Ant 1.6) is included in the distribution:
    ...
    <jcommon-serializer-directory>/build.xml
